...
do
{
    ...
    switch (choice)
    {
        case 1:
            ...
            bank.CreateAccount(customer,accountType,amount);
            break;
        case 2:
            try
            {
                ...
                float balance = bank.Deposit(accountNumber, depositAmount);
        ...
        case 4:
            try
            {
                ...
                accountNumber = Convert.ToInt32(Console.ReadLine());
                Console.WriteLine("Your account balance is " + bank.GetBalance(accountNumber));
            }
            catch (Exception e)
            {
                Console.WriteLine(e.Message);
        ...
        case 5:
            try
            {
                ...
                bank.Transfer(fromAccountNumber, toAccountNumber, amounts);
            }
            catch (Exception e)
            {
                Console.WriteLine(e.Message);
